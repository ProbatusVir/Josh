...
@bot.tree.command(name="download-to-host", description='Download a YouTube video to {config["DEVELOPER_USERNAME"]}\'s computer!')
...
@bot.tree.command(name="sync", description='Only for {config["DEVELOPER_USERNAME"]}! Synchronizes slash commands with your server.')
